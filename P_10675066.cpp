...
int stu_base_id=10600000;
int sta_base_id=11600000;
int stu_count = 0;
int sta_count = 0;
string str;int num;
...
int main()
{
    ...
    while (true){
       ...
       cin >> str;
       if (str == "1"){
            print("\nstudent directory");//change this print statement
            while (true){
                print("\n\n1. add \n2. edit \n3. manage \n0. exit");
                print("\n\nselect an option : ");
                cin >> option;
...
if (stu_id != 0){
    ...
    while (stu_id < 0 || stu_id >= stu_count){
        print("\n( incorrect ) Enter Students ID or 0 to leave : ");
        cin >> stu_id;
        while (cin.fail()){
            cin.clear();cin.ignore();
            print("\n( incorrect ) Enter valid student ID : ");
            cin >> stu_id;
        }
        if(stu_id != 0){
            stu_id -= stu_base_id;
...
if (stu_id != 0){
    ...
    if (pass == 1){
        ...
        //editing student
        while (true){
            print("\n\n1. enter students mark \n2. display academic records \n3. remove student \n0. exit\n");
            print("\nWhat do you want to do : ");
            string manage;
            cin >> manage;
            if (manage == "1"){
                int len = obj.subjects.size();
                print("Enter the sem? (1,2) : ");
                cin >> num;
                while (num != 1 && num != 2){
                    print("Enter the sem? (1,2) : ");
                    cin >> num;
                ...
                print("\nDo you want to remove student? (y/n) : ");
                cin >> str;str = lower(str);
                while (str != "y" && str != "n"){
...
if (sta_id != 0){
    ...
    while (sta_id < 0 || sta_id >= stu_count){
        print("\n( incorrect ) Enter Staffs ID or 0 to leave : ");
        cin >> sta_id;
        while (cin.fail()){
            cin.clear();cin.ignore();
            print("\n( incorrect ) Enter valid Staff ID : ");
            cin >> sta_id;
        }
        if(sta_id != 0){
            sta_id -= sta_base_id;
...
if (sta_id != 0){
    ...
    while (sta_id < 0 || sta_id >= sta_count){
        print("\n( incorrect ) Enter Staff ID or 0 to leave : ");
        cin >> sta_id;
        while (cin.fail()){
            cin.clear();cin.ignore();
            print("\n( incorrect ) Enter valid staff ID : ");
